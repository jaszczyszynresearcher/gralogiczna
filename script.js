...
function calculateResults() {
  ...
  setTimeout(() => {
    ...
    const teamFeedback = feedbackCondition === 'Wygrana' ? 'Gratulacje! Wasz zespół wygrał!' : 'Niestety, tym razem Zespół Przeciwny był lepszy.';
    ...
    window.parent.postMessage({ feedback: feedbackCondition }, '*');
